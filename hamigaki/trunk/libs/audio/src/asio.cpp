...
{
    __emit__(0x8B); __emit__(0x45); __emit__(0x0C);
    __emit__(0x50);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x11);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x0C);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}

inline ::ASIOError asio_start(::IASIO*)
{
    __emit__(0x8B); __emit__(0x45); __emit__(0x08);
    __emit__(0x8B); __emit__(0x10);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x1C);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
...
inline ::ASIOError asio_stop(::IASIO*)
{
    ...
    __emit__(0x8B); __emit__(0x10);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x20);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
...
{
    __emit__(0x8B); __emit__(0x45); __emit__(0x18);
    __emit__(0x50);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x14);
    __emit__(0x51);
    __emit__(0x8B); __emit__(0x55); __emit__(0x10);
    __emit__(0x52);
    __emit__(0x8B); __emit__(0x45); __emit__(0x0C);
    __emit__(0x50);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x11);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x2C);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
...
inline ::ASIOError asio_get_sample_rate(::IASIO*, ::ASIOSampleRate*)
{
    ...
    __emit__(0x8B); __emit__(0x11);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x34);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
...
{
    __emit__(0x83); __emit__(0xEC); __emit__(0x08);
    __emit__(0xDD); __emit__(0x45); __emit__(0x0C);
    __emit__(0xDD); __emit__(0x1C); __emit__(0x24);
    __emit__(0x8B); __emit__(0x45); __emit__(0x08);
    __emit__(0x8B); __emit__(0x10);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x38);
    __emit__(0xFF); __emit__(0xD0);
    __emit__(0x83); __emit__(0xEC); __emit__(0x08);
    __emit__(0xDD); __emit__(0x45); __emit__(0x0C);
    __emit__(0xDD); __emit__(0x1C); __emit__(0x24);
...
inline ::ASIOError asio_get_channel_info(::IASIO*, ::ASIOChannelInfo*)
{
    ...
    __emit__(0x8B); __emit__(0x11);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x48);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
    ...
    ::ASIOBufferInfo*, long, long, ::ASIOCallbacks*)
{
    ...
    __emit__(0x8B); __emit__(0x11);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x4C);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
...
inline ::ASIOError asio_output_ready(::IASIO*)
{
    ...
    __emit__(0x8B); __emit__(0x10);
    __emit__(0x8B); __emit__(0x4D); __emit__(0x08);
    __emit__(0x8B); __emit__(0x42); __emit__(0x5C);
    __emit__(0xFF); __emit__(0xD0);
    return _EAX;
}
#else
