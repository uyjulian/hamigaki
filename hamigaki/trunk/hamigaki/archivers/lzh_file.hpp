...
{
private:
    typedef detail::basic_lzh_file_sink_impl<Sink,Path> impl_type;
...
private:
    basic_lzh_file_sink<iostreams::file_sink,boost::filesystem::path> impl_;
};
...
public:
    ...
    explicit wlzh_file_sink(const std::string& filename)
        : impl_(iostreams::file_sink(filename, BOOST_IOS::binary))
    {
    }
...
private:
    basic_lzh_file_sink<iostreams::file_sink,boost::filesystem::wpath> impl_;
};
#endif
