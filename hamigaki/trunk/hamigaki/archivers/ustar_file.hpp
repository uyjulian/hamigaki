...
class ustar_file_source
    : public basic_ustar_file_source<iostreams::file_source>
{
    typedef basic_ustar_file_source<iostreams::file_source> base_type;
...
class ustar_file_sink
    : public basic_ustar_file_sink<iostreams::file_sink>
{
private:
    typedef basic_ustar_file_sink<iostreams::file_sink> base_type;
