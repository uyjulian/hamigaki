//  cl_parser.hpp: IEEE P1282 "CL" System Use Entry parser
...
#ifndef HAMIGAKI_ARCHIVERS_RRIP_CL_PARSER_HPP
#define HAMIGAKI_ARCHIVERS_RRIP_CL_PARSER_HPP
...
struct cl_parser
{
    ...
    bool operator()(Header& head, const char* s, std::size_t size) const
    {
        ...
        head.flags |= iso::file_flags::directory;
        return true;
    }
};
...
#endif // HAMIGAKI_ARCHIVERS_RRIP_CL_PARSER_HPP
