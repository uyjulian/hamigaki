...
# regression-logs.pl for Hamigaki Library
...
print "<html>\n",
    "<head>\n",
    "<title>Hamigaki Regression Tests</title>\n",
    ...
    "<table border=\"0\">\n",
    "<tr>\n",
    "<td><img border=\"0\" src=\"../hamigaki.png\" width=\"96\" height=\"72\"></td>\n",
    "<td><h1>Hamigaki Regression Tests</h1></td>\n",
    "</tr>\n",
    "</table>\n",
    "\n",
