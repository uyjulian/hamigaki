// file_descriptor_test.cpp: test case for file descriptor
...
{
    const std::string filename("fd_test.dat");
...
void io_test()
{
    ...
    io_ex::file_descriptor dev(filename, BOOST_IOS::trunc);
...
{
    ut::test_suite* test = BOOST_TEST_SUITE("file descriptor test");
