...
#ifndef HAMIGAKI_BJAM2_BJAM_EXCEPTIONS_HPP
#define HAMIGAKI_BJAM2_BJAM_EXCEPTIONS_HPP
...
class HAMIGAKI_BJAM2_DECL exception_data
{
public:
...
class HAMIGAKI_BJAM2_DECL cannot_open_file : public std::exception
{
public:
...
class HAMIGAKI_BJAM2_DECL module_not_found : public std::exception
{
public:
...
class HAMIGAKI_BJAM2_DECL rule_not_found : public std::exception
{
public:
...
class HAMIGAKI_BJAM2_DECL already_defined_class : public std::exception
{
public:
...
class HAMIGAKI_BJAM2_DECL exit_exception : public std::exception
{
public:
...
#endif // HAMIGAKI_BJAM2_BJAM_EXCEPTIONS_HPP
