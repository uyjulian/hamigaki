...
HAMIGAKI_BJAM2_DECL string_list always(context& ctx)
{
    set_target_flags(ctx, target::force_update);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list depends(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list echo(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list exit(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list glob(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list glob_recursive(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list includes(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list rebuilds(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list leaves(context& ctx)
{
    set_target_flags(ctx, target::leaves);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list match(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list no_care(context& ctx)
{
    set_target_flags(ctx, target::no_care);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list not_file(context& ctx)
{
    set_target_flags(ctx, target::not_file);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list no_update(context& ctx)
{
    set_target_flags(ctx, target::no_update);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list temporary(context& ctx)
{
    set_target_flags(ctx, target::temporary);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list is_file(context& ctx)
{
    set_target_flags(ctx, target::is_file);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list fail_expected(context& ctx)
{
    set_target_flags(ctx, target::fail_expected);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list rm_old(context& ctx)
{
    set_target_flags(ctx, target::rm_old);
    return string_list();
}

HAMIGAKI_BJAM2_DECL string_list update(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list subst(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list rule_names(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list var_names(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list delete_module(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list import(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list export_(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list caller_module(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list back_trace(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    const string_list& arg1 = args[0];
...
HAMIGAKI_BJAM2_DECL string_list pwd(context& ctx)
{
    return string_list(ctx.working_directory());
}

HAMIGAKI_BJAM2_DECL string_list import_module(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list instance(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list sort(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list normalize_path(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();

    return string_list(bjam2::normalize_path(args[0]));
}

HAMIGAKI_BJAM2_DECL string_list calc(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list native_rule(context& ctx)
{
    ...
    typedef std::map<std::string,bjam2::native_rule> table_type;
    ...
    const bjam2::native_rule& rule = it->second;

    rule_definition def;
    def.parameters = rule.parameters;
    def.body = rule.native;
...
HAMIGAKI_BJAM2_DECL string_list has_native_rule(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list check_if_file(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
HAMIGAKI_BJAM2_DECL string_list w32_getreg(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
...
HAMIGAKI_BJAM2_DECL string_list shell(context& ctx)
{
    frame& f = ctx.current_frame();
    const list_of_list& args = f.arguments();
    ...
    return bjam2::shell(cmd, need_status, need_capture);
}

} // namespace builtins

HAMIGAKI_BJAM2_DECL void set_builtin_rules(context& ctx)
{
    list_of_list params;
