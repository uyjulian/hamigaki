...
#include <hamigaki/bjam2/bjam_version.hpp>
...
#include <hamigaki/detail/environment.hpp>
    ...
    #define HAMIGAKI_BJAM2_OSMAJOR "NT"
    #define HAMIGAKI_BJAM2_OSMINOR "NT"
#else
    #define HAMIGAKI_BJAM2_OSMAJOR "UNIX"
    #if defined(__CYGWIN__)
        #define HAMIGAKI_BJAM2_OSMINOR "CYGWIN"
    #elif defined(linux) || defined(__linux) || defined(__linux__)
        #define HAMIGAKI_BJAM2_OSMINOR "LINUX"
    #else
        #define HAMIGAKI_BJAM2_OSMINOR "UNKNOWN"
    #endif
#endif

#if defined(_M_IX86) || defined(__i386__)
    #define HAMIGAKI_BJAM2_OSPLAT "X86"
#elif defined( __ia64__ ) || defined( __IA64__ )
    #define HAMIGAKI_BJAM2_OSPLAT "IA64"
#else
    #define HAMIGAKI_BJAM2_OSPLAT ""
#endif
...
HAMIGAKI_BJAM2_DECL void set_predefined_variables(context& ctx)
{
    ...
    m.variables.set_values(
        ...
        boost::assign::list_of
            (HAMIGAKI_BJAM2_VERSION_MAJOR_SYM)
            (HAMIGAKI_BJAM2_VERSION_MINOR_SYM)
            (HAMIGAKI_BJAM2_VERSION_PATCH_SYM)
    );
    ...
    m.variables.set_values(HAMIGAKI_BJAM2_OSMAJOR, string_list("true"));
    m.variables.set_values("OS", string_list(HAMIGAKI_BJAM2_OSMINOR));
    m.variables.set_values("OSPLAT", string_list(HAMIGAKI_BJAM2_OSPLAT));
    m.variables.set_values(
        "JAMVERSION", string_list(HAMIGAKI_BJAM2_JAMVERSION));
}
